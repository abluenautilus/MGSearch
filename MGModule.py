...
class MGModule:
    ...
    def search(self, searchterm, num_alternates):
        ...
        if search_result.status_code == 200:
            ...
            if num_found == 0:
                ...
                print("Found one single result, will load...")
                ...
                print("%d results, showing most popular" % (num_found))
            ...
            if num_alternates > 0:
                ...
                for result_count in range(1, min(num_alternates,num_found)):
                    ...
                    if result_count <= max_results:
                        ...
                        print("%d: %s %s <%s>" % (result_count+1, vendor, module_name, url))



        else:
            print("Error searching for module.")